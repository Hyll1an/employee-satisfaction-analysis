...
<img width="1427" height="798" alt="employee_sats_survey" src="https://github.com/user-attachments/assets/ceae6654-3ce5-467b-b433-4adeda58c86a" />
...
Construir um dashboard capaz de facilitar a análise da satisfação dos colaboradores, permitindo identificar padrões, comparar resultados e visualizar indicadores relevantes para apoiar decisões relacionadas à gestão de pessoas.
...
- Índices de satisfação por tema (Saúde, Carga horária e Salário)
- Filtro por filial da empresa (Alfa, Beta, Gama, Sul)
- Navegação interativa entre as quatro unidades analisadas
...
- Como está distribuído o perfil dos colaboradores por idade e cargo?
